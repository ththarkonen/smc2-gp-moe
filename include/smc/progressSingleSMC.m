function [triggerUpdateFcn] = progressSingleSMC(totalLoops, varargin)
...
%     end
    ...
    ratio = 1 / totalLoops;
    limit = ratio;
    lastsize = fprintf('Starting single step SMCs...\n');
    ...
    function updateWaitbar(~)
        ...
        if( limit >= 0.01 )
            ...
            lastsize = fprintf( 'Single step SMCs %s%% done.\n', num2str( 100 * progress));
            limit = 0;
        end
